...
export default function ImageCompressor() {
  ...
  return (
    <div className="min-h-[80vh] bg-gray-50 text-gray-800 font-sans flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="flex-1 relative bg-gray-100 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 p-4 md:p-8 overflow-y-auto flex flex-col items-center justify-center">
          {!file ? (
            ...
            // IMAGE PREVIEW AREA
            <div className="w-full max-w-5xl bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-200 flex flex-col h-[80vh] md:h-auto">
              {/* Comparison Viewer */}
              <div className="relative w-full h-[300px] md:h-[400px] bg-[url('https://t3.ftcdn.net/jpg/02/03/99/33/360_F_203993306_c6ZlC4c70337851351113.jpg')] bg-repeat">
                {compressedResult ? (
                  ...
                  <div className="absolute inset-0 select-none overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4 bg-green-600/80 text-white px-3 py-1 rounded-full text-xs font-bold backdrop-blur-sm">
                      Compressed
                    </div>
                  </div>
                ) : (
        ...
        <div className="p-6 space-y-8 flex-1">
          {file ? (
                  ...
                  <div className="text-right">
                    {compressedResult ? (
                      <div className="flex flex-col items-end animate-in slide-in-from-bottom-2">
                        ...
                        <span className="text-xs font-bold text-white bg-green-500 px-1.5 py-0.5 rounded">
                          -{compressedResult.saved.toFixed(0)}%
                        </span>
                      </div>
                    ) : (
            ...
            <div className="h-full flex flex-col items-center justify-center text-center text-gray-400">
              ...
              <p className="text-sm">
                Upload an image to <br /> adjust compression settings.
              </p>
            </div>
          )}
        </div>
